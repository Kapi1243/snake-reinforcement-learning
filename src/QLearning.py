"""
Legacy Q-Learning Script (Deprecated)

This script has been refactored into QLearningAgent.py with improved code quality.
Kept for backward compatibility.

For new projects, please use:
    from QLearningAgent import QLearningAgent
    
See notebooks/Snake_QLearning_Tutorial.ipynb for usage examples.
"""

import warnings

warnings.warn(
    "QLearning.py is deprecated. Please use QLearningAgent.py instead.",
    DeprecationWarning,
    stacklevel=2,
)
