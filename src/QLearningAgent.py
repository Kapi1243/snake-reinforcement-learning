...
class QLearningAgent:
    ...
    def train(
        ...
        if verbose:
            ...
            print(
                f"Hyperparameters: γ={self.gamma}, ε={self.epsilon}→{self.min_epsilon}, α={self.learning_rate}"
            )
        ...
        for episode in range(num_episodes):
            ...
            if episode % eval_frequency == 0:
                ...
                if verbose:
                    print(
                        f"Episode {episode:5d} | Avg Score: {avg_score:.2f} | "
        ...
        return {
            ...
            "final_avg_score": self.training_history[-1]["avg_score"]
    ...
    def evaluate(
        self, board_size: int = 16, num_episodes: int = 25, max_steps: int = 100
...
def create_training_animation(
    ...
    ani = animation.FuncAnimation(
        fig, animate, frames=num_frames, blit=True, interval=75, repeat=True
    )
